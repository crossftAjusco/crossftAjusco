...
const UserPayments = () => {
  ...
  const userData = users.filter((us) => {
    //Comprobamos el correo del usuario logueado
            ...
            <List aria-label="contacts">
              ...
              <Paper elevation={4}>
                <ListItem className="li2">
                  ...
                  <td>
                    {uD.payment_days[
                      Object.keys(uD.payment_days)[
                        Object.keys(uD.payment_days).length - 1
                      ]
                    ]
                      .toDate()
              ...
              <Paper elevation={4}>
                ...
                <Paper elevation={4}>
                  <ListItem className="li4">
                    <p>
                      Puedes realizar tus pagos en efectivo de manera personal
                      con tu coach, o puedes hacer una transferencia bancaria a
                      través del número de cuenta clabe
                    </p>
                  </ListItem>
                </Paper>
              </Paper>
